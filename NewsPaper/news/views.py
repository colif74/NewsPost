...
class AppointmentView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        send_mail(
                    ...
                    from_email='colif74@yandex.ru',  # здесь указываете почту, с которой будете отправлять (об этом попозже)
                    recipient_list=['colif@mail.ru', 'colif74@gmail.com']  # здесь список получателей. Например, секретарь, сам врач и т. д.
                )
