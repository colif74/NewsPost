...
from .forms import PostForm,  BaseRegisterForm, subscribe
...
class PostCategory(ListView):
    ...
    def get_queryset(self):
        self.category = Category.objects.get(pk=self.kwargs['pk']).PostCategory.all()
    ...
    # def get_queryset(self):
    #     self.category = get_list_or_404(Category, id=self.kwargs['pk'])
